...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WT)
      ...
      CALL OXXXXX(P(0,3),MDL_MT,+1,+1*IC(3),W(1,5))  !  count 4
      CALL OXXXXX(P(0,3),MDL_MT,-1,+1*IC(3),W(1,6))  !  count 4
      CALL IXXXXX(P(0,4),MDL_MT,+1,-1*IC(4),W(1,7))  !  count 4
      CALL IXXXXX(P(0,4),MDL_MT,-1,-1*IC(4),W(1,8))  !  count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11,ZERO,FK_ZERO,W(1,9))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11,ZERO,FK_ZERO,W(1,10))  !  count 4
      CALL FFV1P1N_1(W(1,5), W(1,9), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,5), W(1,10), GC_11, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,6), W(1,9), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,6), W(1,10), GC_11, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
        JAMP(1,1) = (1.666666666666667D-01)*AMP( K,1)
        JAMP(2,1) = (-5.000000000000000D-01)*AMP( K,1)
